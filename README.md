...
Here is a [three-minute presentation video](https://www.youtube.com/watch?v=x7scyiUHK7g) to understand the idea behind AutoCattlogger for non-specialist audience.
...
> - [Black-mirror light-probe cow model for specular highlight removal to improve Holstein cattle identification](https://ieeexplore.ieee.org/document/11386210): Introduced scene-illumination modeling using fully black cows for color-correction. Color-correction improves the quality of the generated barcodes. [Presentation video link.](https://youtu.be/Ss9M-uAg-rY)
